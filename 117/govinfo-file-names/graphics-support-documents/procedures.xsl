...
<xsl:template match="uslm:preliminary">
...
<xsl:template match="uslm:tocItem/uslm:content/uslm:ref/uslm:inline[@name='number']"/>
<xsl:template match="uslm:tocItem/uslm:heading/uslm:ref/uslm:inline[@name='number']"/>
